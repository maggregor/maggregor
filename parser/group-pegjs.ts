...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c2 = "$group:";
  const peg$c3 = peg$literalExpectation("$group:", false);
  const peg$c4 = "_id:";
  const peg$c5 = peg$literalExpectation("_id:", false);
  const peg$c6 = ",";
  ...
  const peg$c14 = /^[a-zA-Z0-9]/;
  const peg$c15 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"]], false, false);
  const peg$c16 = "\"";
  const peg$c17 = peg$literalExpectation("\"", false);
  const peg$c18 = function(key: any): any { return key.join(''); };
  const peg$c19 = "$sum:";
  const peg$c20 = peg$literalExpectation("$sum:", false);
  const peg$c21 = function(id: any): any { return { type: 'sum', field: id }};
  const peg$c22 = "$avg:";
  const peg$c23 = peg$literalExpectation("$avg:", false);
  const peg$c24 = function(id: any): any { return { type: 'avg', field: id }};
  const peg$c25 = "$first:";
  const peg$c26 = peg$literalExpectation("$first:", false);
  const peg$c27 = function(id: any): any { return { type: 'first', field: id }};
  const peg$c28 = "$last:";
  const peg$c29 = peg$literalExpectation("$last:", false);
  const peg$c30 = function(id: any): any { return { type: 'last', field: id }};
  const peg$c31 = "$max:";
  const peg$c32 = peg$literalExpectation("$max:", false);
  const peg$c33 = function(id: any): any { return { type: 'max', field: id }};
  const peg$c34 = "$min:";
  const peg$c35 = peg$literalExpectation("$min:", false);
  const peg$c36 = function(id: any): any { return { type: 'min', field: id }};
  const peg$c37 = "$push:";
  const peg$c38 = peg$literalExpectation("$push:", false);
  const peg$c39 = function(id: any): any { return { type: 'push', field: id }};
  const peg$c40 = "$addToSet:";
  const peg$c41 = peg$literalExpectation("$addToSet:", false);
  const peg$c42 = function(id: any): any { return { type: 'addToSet', field: id }};
  const peg$c43 = peg$otherExpectation("whitespace");
  const peg$c44 = /^[ \t\n\r]/;
  const peg$c45 = peg$classExpectation([" ", "\t", "\n", "\r"], false, false);
  const peg$c46 = function(): any { return null };
                ...
                if (s7 as any !== peg$FAILED) {
                  ...
                  if (s8 as any !== peg$FAILED) {
                    ...
                    if (s9 as any !== peg$FAILED) {
                      s10 = peg$parseidentifierNoQuote();
  ...
  function peg$parseidentifierNoQuote(): any {
    let s0, s1, s2, s3;
  ...
  function peg$parseaggregation(): any {
    let s0, s1, s2, s3;
