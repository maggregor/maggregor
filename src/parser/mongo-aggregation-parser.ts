...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c6 = function (stage: any): any {
    return [stage];
  };
  const peg$c7 = '{';
  ...
  const peg$c17 = function (type: any, stage: any): any {
    return { type, ...stage };
  };
  const peg$c18 = 'match';
  ...
  const peg$c24 = function (groupId: any, accumulators: any): any {
    return { _id: groupId, accumulators: accumulators };
  };
  const peg$c25 = function (outputFieldName: any, expression: any): any {
    return { outputField: outputFieldName, ...expression };
  };
  const peg$c26 = function (operator: any, values: any): any {
    return { operator, values };
  };
  const peg$c27 = function (value: any, values: any): any {
    return [value, ...values];
  };
  ...
  const peg$c45 = function (conditions: any): any {
    return { conditions };
  };
  const peg$c46 = 'and';
  ...
  const peg$c52 = function (operator: any, conditions: any): any {
    return { operator, conditions };
  };
  const peg$c53 = function (condition: any, conditions: any): any {
    return [condition, ...conditions];
  };
  const peg$c54 = function (condition: any): any {
    return condition;
  };
  const peg$c55 = function (fieldName: any, condition: any): any {
    return { fieldName, condition };
  };
  const peg$c56 = function (limitValue: any): any {
  ...
  const peg$c69 = function (operator: any, value: any): any {
    return { operator, value };
  };
  const peg$c70 = function (field: any, value: any): any {
    return { field, value };
  };
  const peg$c71 = 'add';
  ...
  const peg$c96 = function (firstLetter: any, restLetters: any): any {
  ...
  const peg$c111 = function (chars: any): any {
    return chars.join('');
  };
  const peg$c112 = "'";
            ...
            if ((s4 as any) === peg$FAILED) {
              ...
              if ((s4 as any) === peg$FAILED) {
                ...
                if ((s4 as any) === peg$FAILED) {
                  ...
                  if ((s4 as any) === peg$FAILED) {
                    if (
                      input.substr(peg$currPos, 3).toLowerCase() === peg$c67
                    ) {
                      s4 = input.substr(peg$currPos, 3);
                      peg$currPos += 3;
                    } else {
