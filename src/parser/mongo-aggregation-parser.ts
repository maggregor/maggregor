...
import type { Stage } from '@core/pipeline/stages';
...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c24 = function (groupExpr: any, accumulators: any): any {
    return { groupExpr, accumulators };
  };
  const peg$c25 = function (outputFieldName: any, gr: any): any {
    return createBasicAccumulator({
      outputFieldName,
      operator: gr.operator,
      expression: gr.expression,
    });
  };
  const peg$c26 = function (operator: any, expression: any): any {
  ...
  const peg$c45 = function (conditionEnums: any): any {
  ...
  const peg$c55 = function (field: any, value: any): any {
  ...
  const peg$c71 = function (n: any): any {
    return { value: n };
  };
  const peg$c72 = 'add';
  ...
  const peg$c92 = function (chars: any): any {
  ...
  const peg$c97 = function (firstLetter: any, restLetters: any): any {
  ...
  const peg$c112 = function (chars: any): any {
    return chars.join('');
  };
  const peg$c113 = "'";
