...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c4 = function(stages: any): any { return stages as Stage[]; };
  const peg$c5 = ",";
  const peg$c6 = peg$literalExpectation(",", false);
  const peg$c7 = function(head: any, s: any): any { return s; };
  const peg$c8 = function(head: any, tail: any): any { return [head, ...tail]; };
  const peg$c9 = "{";
  const peg$c10 = peg$literalExpectation("{", false);
  const peg$c11 = "$";
  const peg$c12 = peg$literalExpectation("$", false);
  const peg$c13 = "group";
  const peg$c14 = peg$literalExpectation("group", true);
  const peg$c15 = ":";
  ...
  const peg$c20 = "match";
  const peg$c21 = peg$literalExpectation("match", true);
  const peg$c22 = "limit";
  const peg$c23 = peg$literalExpectation("limit", true);
  const peg$c24 = "_id";
  const peg$c25 = peg$literalExpectation("_id", false);
  const peg$c26 = function(groupExpr: any, accumulators: any): any { return {groupExpr, accumulators}; };
  const peg$c27 = function(outputFieldName: any, gr: any): any { return createBasicAccumulator({outputFieldName, operator: gr.operator, expression: gr.expression}) };
  const peg$c28 = function(operator: any, expression: any): any { return { operator, expression }; };
  const peg$c29 = function(value: any, values: any): any { return [value, ...values]; };
  const peg$c30 = function(value: any): any { return value; };
  const peg$c31 = "addtoset";
  const peg$c32 = peg$literalExpectation("addToSet", true);
  const peg$c33 = "avg";
  const peg$c34 = peg$literalExpectation("avg", true);
  const peg$c35 = "first";
  const peg$c36 = peg$literalExpectation("first", true);
  const peg$c37 = "last";
  const peg$c38 = peg$literalExpectation("last", true);
  const peg$c39 = "max";
  const peg$c40 = peg$literalExpectation("max", true);
  const peg$c41 = "min";
  const peg$c42 = peg$literalExpectation("min", true);
  const peg$c43 = "push";
  const peg$c44 = peg$literalExpectation("push", true);
  const peg$c45 = "sum";
  const peg$c46 = peg$literalExpectation("sum", true);
  const peg$c47 = function(conditionEnums: any): any { return { conditions: conditionEnums.flat() }; };
  const peg$c48 = "and";
  const peg$c49 = peg$literalExpectation("and", true);
  const peg$c50 = "or";
  const peg$c51 = peg$literalExpectation("or", true);
  const peg$c52 = "not";
  const peg$c53 = peg$literalExpectation("not", true);
  const peg$c54 = function(operator: any, conditions: any): any { return { operator, conditions }; };
  const peg$c55 = function(condition: any, conditions: any): any { return [condition, ...conditions]; };
  const peg$c56 = function(condition: any): any { return condition; };
  const peg$c57 = function(field: any, value: any): any { return { operator: 'eq', value: [{ field }, { value }]}; };
  const peg$c58 = function(limitValue: any): any { return { limit: limitValue }; };
  const peg$c59 = "eq";
  const peg$c60 = peg$literalExpectation("eq", true);
  const peg$c61 = "ne";
  const peg$c62 = peg$literalExpectation("ne", true);
  const peg$c63 = "gt";
  const peg$c64 = peg$literalExpectation("gt", true);
  const peg$c65 = "gte";
  const peg$c66 = peg$literalExpectation("gte", true);
  const peg$c67 = "lt";
  const peg$c68 = peg$literalExpectation("lt", true);
  const peg$c69 = "lte";
  const peg$c70 = peg$literalExpectation("lte", true);
  const peg$c71 = function(operator: any, value: any): any { return { operator, value }; };
  const peg$c72 = function(field: any, value: any): any { return { field, value }; };
  const peg$c73 = function(n: any): any { return { value: n } };
  const peg$c74 = "add";
  const peg$c75 = peg$literalExpectation("add", true);
  const peg$c76 = "subtract";
  const peg$c77 = peg$literalExpectation("subtract", true);
  const peg$c78 = "multiply";
  const peg$c79 = peg$literalExpectation("multiply", true);
  const peg$c80 = "divide";
  const peg$c81 = peg$literalExpectation("divide", true);
  const peg$c82 = "toupper";
  const peg$c83 = peg$literalExpectation("toUpper", true);
  const peg$c84 = "tolower";
  const peg$c85 = peg$literalExpectation("toLower", true);
  const peg$c86 = "cond";
  const peg$c87 = peg$literalExpectation("cond", true);
  const peg$c88 = "\"$";
  ...
  const peg$c94 = function(chars: any): any { return { field: chars.join('') } };
  const peg$c95 = /^[a-zA-Z_]/;
  const peg$c96 = peg$classExpectation([["a", "z"], ["A", "Z"], "_"], false, false);
  const peg$c97 = /^[a-zA-Z0-9_.]/;
  const peg$c98 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_", "."], false, false);
  const peg$c99 = function(firstLetter: any, restLetters: any): any { return firstLetter + restLetters.join(''); };
  const peg$c100 = /^[0-9]/;
  const peg$c101 = peg$classExpectation([["0", "9"]], false, false);
  const peg$c102 = function(): any { return parseInt(text()); };
  const peg$c103 = "-";
  const peg$c104 = peg$literalExpectation("-", false);
  const peg$c105 = ".";
  const peg$c106 = peg$literalExpectation(".", false);
  const peg$c107 = "e";
  const peg$c108 = peg$literalExpectation("e", true);
  const peg$c109 = "E";
  const peg$c110 = peg$literalExpectation("E", false);
  const peg$c111 = "+";
  const peg$c112 = peg$literalExpectation("+", false);
  const peg$c113 = function(): any { return parseFloat(text()); };
  const peg$c114 = function(chars: any): any { return chars.join(''); };
  const peg$c115 = "'";
  const peg$c116 = peg$literalExpectation("'", false);
  const peg$c117 = /^[^']/;
  const peg$c118 = peg$classExpectation(["'"], true, false);
  const peg$c119 = "true";
  const peg$c120 = peg$literalExpectation("true", true);
  const peg$c121 = function(): any { return true; };
  const peg$c122 = "false";
  const peg$c123 = peg$literalExpectation("false", true);
  const peg$c124 = function(): any { return false; };
  const peg$c125 = "null";
  const peg$c126 = peg$literalExpectation("null", true);
  const peg$c127 = function(): any { return null; };
  const peg$c128 = peg$otherExpectation("whitespace");
  const peg$c129 = /^[ \t\n\r]/;
  ...
  function peg$parsestageArray(): any {
